    ...
    return (
        <ChakraCard mx="2" my="4" w="80" overflow="hidden" onClick={handleClick}>
            ...
            <CardBody display="flex" justifyContent="center" alignItems="center">
                <img src={imageUrl || fallBackImage} alt={name} width={223} height={310} />
            </CardBody>
            <CardFooter>
